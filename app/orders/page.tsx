...
export default function OrdersPage() {
    ...
    useEffect(() => {
        if (user?.id) {
            ...
            const url = `${API_URL}/api/users/${user.id}/orders`;
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-3xl pt-20 md:pt-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">Order History</h1>

            {orders.length === 0 ? (
                <div className="text-center py-12">
                    <div className="inline-flex items-center justify-center p-6 bg-gray-100 dark:bg-gray-800 rounded-full mb-6">
                    ...
                    <Link href="/" className="bg-orange-600 text-white px-6 py-2 rounded-lg hover:bg-orange-700 transition">
                        Browse Menu
                    </Link>
                </div>
            ) : (
                        ...
                        <div key={order.id} className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden shadow-sm hover:shadow-md transition-shadow">
                            <div className="p-4 border-b border-gray-100 dark:border-gray-700 flex flex-wrap justify-between items-center gap-4 bg-gray-50 dark:bg-gray-900/50">
                                ...
                                <div>
                                    ...
                                    <span className={`inline-block px-2 py-1 text-xs font-bold rounded-full ${order.status === 'completed' ? 'bg-green-100 text-green-700' :
